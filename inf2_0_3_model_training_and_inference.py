# %% [markdown]
# # 1. MODEL1 CV [0.01562060391771847] LB [0.01833]
...
qt = pickle.load(open('../input/25-3m1/qt.pkl', 'rb')) ##1
...
pca_g = pickle.load(open('../input/25-3m1/pca_g.pkl', 'rb')) ##2
...
pca_c = pickle.load(open('../input/25-3m1/pca_c.pkl', 'rb')) ##3
...
var_thresh = pickle.load(open('../input/25-3m1/var_tm.pkl', 'rb')) ##4
...
def fe_cluster(train, test, n_clusters_g = 22, n_clusters_c = 4, SEED = 42):
    ...
    def create_cluster(train, test, features, kind = 'g', n_clusters = n_clusters_g):
        ...
        kmeans = pickle.load(open(f'../input/25-3m1/kmeans1_{kind}.pkl', 'rb')) ##5.6
...
def fe_cluster_pca(train, test,n_clusters=5,SEED = 42):
        ...
        kmeans = pickle.load(open('../input/25-3m1/kmeans2.pkl', 'rb')) ##7
...
def run_training(fold_id, seed_id):
    ...
    model.load_state_dict(torch.load(f"../input/25-3m1/SCORED_ONLY_FOLD{fold_id}_SEED{seed_id}.pth"))  ##8
    model.to(DEVICE)
